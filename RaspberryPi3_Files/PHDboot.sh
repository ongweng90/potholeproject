...
echo "begin script" #echo's for debugging purposes
echo "running main script"
/usr/bin/python2.7 /home/pi/DistanceDetector/showtext -t DrivingMode #show text calls 16x2 LCD screen and display's argument
